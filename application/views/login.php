...
<html lang="en">
  <head>
    ...
    <title>Land Bank Management System | Login</title>
    ...
    <!-- Animate.css -->
    <link href="<?php echo base_url(); ?>assets/Assets/vendors/animate.css/animate.min.css" rel="stylesheet">
          ...
          <?php echo validation_errors(); ?>
            <form  action="<?php echo base_url();?>index.php/login/login_user" method="POST">
              ...
              <!-- <div class="separator">
                ...
                <div>
                  <h1></i>Land Bank Management System </h1>
                  <p>©2016 All Rights Reserved. Muaz and Amir</p>
                </div>
              </div>
            </form>
          </section>
            ...
            <form>
              ...
              <div class="separator">
                ...
                <div>
                  ...
                  <p>©2016 All Rights Reserved. Muaz and Amir. Privacy and Terms</p>
                </div>
              </div>
            </form>
          </section>
