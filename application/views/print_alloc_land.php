                 ...
                 <!--  <?php
                  ...
                  <!-- start accordion -->
                    <div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
                          <div class="panel-body">
                           ...
                           <!--  <h3>Parcel : <b><?php echo $land_details['land_detail'][0]->parcel; ?></b></h3> -->
                            ...
                            <h4><?php echo $this->lang->line('view_transfer_type'); ?> : <b>Merit</b></h3>
                            <h4><?php echo $this->lang->line('view_transferred_to'); ?> : <b><?php echo $land_details['land_detail'][0]->transferred_to ; ?></b></h4>
                            <h4><?php echo $this->lang->line('view_project_title'); ?> : <b><?php echo $land_details['land_detail'][0]->project_title ; ?></b></h4>
                            <h4><?php echo $this->lang->line('view_project_proposal'); ?> : <b><?php if($land_details['land_detail'][0]->project_proposal == 1) echo "Available"; else echo "Not Available"; ?></b></h4>
                            ...
                            <h4><?php echo $this->lang->line('view_eia'); ?> : <b><?php if($land_details['land_detail'][0]->EIA == 1) echo "Available"; else echo "Not Available"; ?></b></h4>
                           <h4><?php echo $this->lang->line('view_transfer_date'); ?> : <b><?php echo $land_details['land_detail'][0]->transfer_date ; ?></b></h4>
                            <h4><?php echo $this->lang->line('view_reclaim_date'); ?> : <b><?php echo $land_details['land_detail'][0]->reclaim_date ; ?></b></h4>

                          </div>
                        </div>
                      </div>

                      <div class="panel bank_image">
                        <a class="panel-heading collapsed" role="tab" id="headingTwo" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                          <h4 class="panel-title"><strong><?php echo $this->lang->line('view_bank_statement'); ?></strong></h4>
                        </a>
                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                          <div class="panel-body">

                            <img class="img-responsive" style="border: 4px solid #26B99A; " src="<?php echo base_url().''.$land_details['land_detail'][0]->bank_statement; ?>" alt="Not Avaialable" />

                          </div>
                        </div>
                      </div>

                      <div class="panel compensation_image">
                        <a class="panel-heading collapsed" role="tab" id="headingTwo" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                          <h4 class="panel-title"><strong><?php echo $this->lang->line('view_compensation'); ?></strong></h4>
                        </a>
                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                          <div class="panel-body">

                              <img class="img-responsive" style="border: 4px solid #26B99A; " src="<?php echo base_url().''.$land_details['land_detail'][0]->compensation; ?>" alt="Not Avaialable" />

                          </div>
                        </div>
                      </div>

                      <div class="panel approval_image">
                        <a class="panel-heading collapsed" role="tab" id="headingTwo" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                          <h4 class="panel-title"><strong><?php echo $this->lang->line('view_approval_letter'); ?></strong></h4>
                        </a>
                        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                          <div class="panel-body">

                            <img class="img-responsive" style="border: 4px solid #26B99A; " src="<?php echo base_url().''.$land_details['land_detail'][0]->approval_letter; ?>" alt="Not Avaialable" />
                      ...
                      <div class="panel">
                        <a class="panel-heading" role="tab" id="headingOne" data-toggle="collapse" data-parent="#accordion" href="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
...
<script src='https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js'></script>
                      <div class="panel map_location">
                        <a class="panel-heading collapsed" role="tab" id="headingTwo" data-toggle="collapse" data-parent="#accordion" href="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
