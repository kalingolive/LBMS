                     ...
                     <!--  <button class="btn btn-default pull-right" id="print_ldetail">Print</button> -->
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
                          <div class="panel-body">
                            ...
                            <h4><?php echo $this->lang->line('view_parcel'); ?> : <b><?php echo $land_details['land_detail'][0]->parcel; ?></b></h4>
                            <h4><?php echo $this->lang->line('view_land_code'); ?> : <b><?php echo $land_details['land_detail'][0]->land_code; ?></b></h4>
                            <h4><?php echo $this->lang->line('view_area'); ?> : <b><?php echo $land_details['land_detail'][0]->area_size . " K.M"; ?></b></h4>
                    ...
                    <!--   <button class="btn btn-default pull-right" id="print_image">Print</button> -->
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                          <div class="panel-body">
                            ...
                            <img class="img-responsive" src="<?php echo base_url().'uploads/lands/'.$land_details['land_detail'][0]->img_src; ?>"  style="border: 4px solid #26B99A; " alt="Not Available"  />
