...
class AddressController extends AbstractController
{
    ...
    /**
     * @Route("/{industry}/new", name="address_new", methods={"GET","POST"})
     */
    public function new( $industry,Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $entityManager->persist($address->setIndustry($industries));
            $entityManager->flush();

           // return $this->redirectToRoute('members_new',['industry'=>$industry]);
